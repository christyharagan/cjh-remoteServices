...
module.exports.localProxyFactory = function (serviceSpec, sender, receiver, close) {
  ...
  return proxyFactory.localProxyFactory(serviceSpec, eventProxyFactory, methodProxyHandler);
};
...
module.exports.remoteProxyFactory = function (serviceSpec, sender, receiver, close) {
  var eventHandlers = {};
  var methodCallbacks = {};
  var closableMethods = {};
  ...
  return proxyFactory.localProxyFactory(serviceSpec, eventProxyHandler, methodProxyFactory);
};